...
SUPPORTED_GENRES = [
    ...
    "historical fiction", "horror", "adventure", "drama", "comedy",
    "dystopian", "urban fantasy", "epic fantasy", "cyberpunk",
    "steampunk", "magical realism", "literary fiction"
]

# Supported tones
SUPPORTED_TONES = [
    "adventurous", "mysterious", "romantic", "comedic", "dark",
    "epic", "intimate", "philosophical", "action-packed", "whimsical",
    "gritty", "lighthearted", "suspenseful", "melancholic", "inspirational"
]
