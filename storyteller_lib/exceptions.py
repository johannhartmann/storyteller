...
class SceneGenerationError(StoryGenerationError):
    ...
    def __init__(self, message: str, chapter: Optional[int] = None, 
                 scene: Optional[int] = None, details: Optional[Dict[str, Any]] = None):
...
class CharacterCreationError(StoryGenerationError):
    ...
    def __init__(self, message: str, character_name: Optional[str] = None,
...
class LanguageValidationError(ValidationError):
    ...
    def __init__(self, message: str, expected_language: str, 
...
class QualityValidationError(ValidationError):
    ...
    def __init__(self, message: str, quality_scores: Optional[Dict[str, float]] = None,
...
class StateTransitionError(StateError):
    ...
    def __init__(self, message: str, from_node: str, to_node: str,
                 details: Optional[Dict[str, Any]] = None):
        super().__init__(message, details)
...
def handle_memory_error(error: Exception, operation: str = "access") -> MemoryError:
    ...
    if operation == "store":
        ...
        return MemoryRetrievalError(f"Failed to retrieve from memory: {error_msg}", details)
    else:
