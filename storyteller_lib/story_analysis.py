...
class StoryAnalyzer:
        ...
        try:
            ...
            return {
                ...
                'statistics': {
                    ...
                    'average_scenes_per_chapter': scene_count / chapter_count if chapter_count > 0 else 0
                },
                ...
                'completeness': {
                    ...
                    'unresolved_threads': plot_status.get('introduced', 0) + plot_status.get('developed', 0)
                }
            }
    ...
    def analyze_character_arc(self, character_id: int) -> Dict[str, Any]:
        ...
        return {
            ...
            'arc_summary': {
                ...
                'first_appearance': journey['appearances'][0] if journey['appearances'] else None,
                'last_appearance': journey['appearances'][-1] if journey['appearances'] else None,
    ...
    def find_revision_candidates(self, story_id: int, change_type: str, 
                               entity_type: str, entity_id: int) -> List[Dict[str, Any]]:
        """
