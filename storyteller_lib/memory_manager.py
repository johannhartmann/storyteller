...
class MemoryManager:
    ...
    def create_memory(self, key: str, value: Any, namespace: Optional[str] = "storyteller") -> None:
    ...
    def update_memory(self, key: str, value: Any, namespace: Optional[str] = "storyteller") -> None:
    ...
    def search_memories(self, query: str, namespace: Optional[str] = "storyteller") -> List[Dict[str, Any]]:
    ...
    def get_memory(self, key: str, namespace: Optional[str] = "storyteller") -> Optional[Any]:
...
def manage_memory(action: str, key: str, value: Optional[Any] = None, namespace: Optional[str] = "storyteller") -> Dict[str, Any]:
...
def search_memory(query: str, namespace: Optional[str] = "storyteller") -> List[Dict[str, Any]]:
